...
QMAKE    = /usr/bin/qmake
tuio-qt.xcodeproj/project.pbxproj: tuio-qt.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.7/mkspecs/macx-xcode -o tuio-qt.xcodeproj/project.pbxproj tuio-qt.pro
